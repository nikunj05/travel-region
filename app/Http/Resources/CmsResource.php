...
class CmsResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            "why_we_exist" => $this->why_we_exist ? collect($this->why_we_exist)->filter(function ($item) { return $item['title'] && $item['description']; })->map(function ($item) {
                return [
            ...
            "few_highlights" => $this->few_highlights ? collect($this->few_highlights)->filter(function ($item) { return $item['title'] && $item['description']; })->map(function ($item) {
                return [
                    'title' => $item['title'] ? $item['title'] : null,
                    'description' => $item['description'] ? $item['description'] : null,
                    'icon' => $item['icon'] ?? null,
