...
Route::prefix('v1')
    ...
    Route::group(['prefix' => 'hotels'], function (): void {
        ...
        Route::get('/{hotelCode}/images', [HotelController::class, 'images'])->name('hotels.images');
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::get('bookings/{order}/cancellation-policies', [BookingController::class, 'showCancellationPolicies'])->name('booking.cancellation-policies');
