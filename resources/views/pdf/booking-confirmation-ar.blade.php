...
<head>
    ...
    <style>
        body {
            font-family: 'DejaVu Sans Condensed', 'DejaVu Sans', sans-serif !important;
            margin: 0;
            padding: 20px;
            direction: rtl;
            text-align: right;
...
<body style="margin: 0; padding: 0; box-sizing: border-box; direction: rtl">
    ...
    <div
        style="display: flex; justify-content:center; padding:0px 0; font-family:'DejaVu Sans Condensed', 'DejaVu Sans', sans-serif; direction:rtl;">
        <div style="width:100%; max-width:95%; background:white; padding:15px; direction:rtl; transform:scale(0.94); transform-origin: top right;">
            <!-- width:794px -->
            ...
            <main style="color: #0b343a; padding-bottom: 65px;">
                                                        ...
                                                        <tr>
                                                            <td align="right" style="font-size: 12px; padding-top: 8px;">
                                                                <div style="border:1px solid #dbc8b6; border-radius:6px; margin-top:12px;">
                                                                    <table width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                                                                        <tr>
                                                                            <td align="right" style="font-size:12px; padding:15px 15px 0 15px;">
                                                                                <strong>ملاحظات</strong>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right" style="font-size:12px; padding:10px 15px 15px 15px;">
                ...
                <!-- FOOTER -->
                <table width="100%" cellspacing="0" cellpadding="0"
                    style="margin-top: 30px; margin-bottom: 35px; border-collapse: collapse">
                    <tr>
