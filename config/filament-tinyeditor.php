...
return [
    ...
    'profiles' => [
        'default' => [
            ...
            'toolbar' => 'undo redo removeformat | fontfamily fontsizeinput font_size_formats styles | bold italic underline | alignjustify alignleft aligncenter alignright | numlist bullist | forecolor backcolor | blockquote table toc hr | emoticons',
    ...
    'extra' => [
        'toolbar' => [
            ...
            'fontfamily' => 'Tahoma=tahoma,arial,helvetica;sans-serif=sans-serif;Arial=arial,helvetica,sans-serif;Courier New=courier new,courier,monospace;Georgia=georgia,palatino,serif;Times New Roman=times new roman,times,serif;Verdana=verdana,geneva,sans-serif;Tajawal=tajawal;',
